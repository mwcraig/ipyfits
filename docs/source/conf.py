...
# -*- coding: utf-8 -*-
#
# ipyfits documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyfits', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyfits.tex', 'ipyfits Documentation',
     'Matt Craig', 'manual'),
]
